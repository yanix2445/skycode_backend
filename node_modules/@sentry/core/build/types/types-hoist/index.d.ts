...
export type { SessionAggregates, AggregationCounts, Session, SessionContext, SessionStatus, SerializedSession, } from './session';
export type { SeverityLevel } from './severity';
export type { Span, SentrySpanArguments, SpanOrigin, SpanAttributeValue, SpanAttributes, SpanTimeInput, SpanJSON, SpanContextData, TraceFlag, } from './span';
